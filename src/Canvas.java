...
public class Canvas extends JApplet {
	public static void main(String[] args) {
		...
		Canvas drawing = new Canvas(800,800);// Creates a new Canvas object
		Circle myCircle = new Circle(400, 400, 100);// Creates a new Circle object
		myCircle.setColor(Color.ORANGE);// Set the color of the Circle object
		drawing.drawShape(myCircle);// Draw the Circle object
